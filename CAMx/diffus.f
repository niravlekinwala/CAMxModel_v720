      subroutine diffus(m1,m2,m3,i0,j0,ia,iz,ja,jz,ibcon,lrtrc,losat,ldepfld,
...
c
c     Input arguments:
c        lrtrc             flag that determines if this is for RTRAC
...
c
      numspcs = nspc
      if( losat .or. lrtrc) numspcs = nsaspc
...
c
     ...
     &                             (1. - fsoil(ll))*fsurf(i,j,ll)*depmas
                   ...
                   depfld1(i,j,l) = depfld1(i,j,l) + depmas
                 endif
              endif
            enddo
c
