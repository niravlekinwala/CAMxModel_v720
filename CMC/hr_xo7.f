...
c --- Local variables:
      ...
      real r214, r215, r216, r217, r218, r219, r220, r221, r222, r223
      real r224, r225, r226, r227, r228, r229
c
c --- Entry Point
c
      N2 = M - O2
...
c
      r214 = rk(214)*y1(lI2)
      r215 = rk(215)*y1(lHOI)
      r216 = rk(216)*y1(lI)*yh(lO3)
      r217 = rk(217)*y1(lIO)
      r218 = rk(218)*y1(lIO)*y1(lIO)
      r219 = rk(219)*y1(lIO)*yh(lHO2)
      r220 = rk(220)*y1(lIO)*yh(lNO)
      r221 = rk(221)*y1(lIO)*yh(lNO2)
      r222 = rk(222)*y1(lOIO)
      r223 = rk(223)*y1(lOIO)*yh(lOH)
      r224 = rk(224)*y1(lOIO)*y1(lIO)
      r225 = rk(225)*y1(lOIO)*yh(lNO)
      r226 = rk(226)*y1(lI2O2)
      r227 = rk(227)*y1(lI2O2)
      r228 = rk(228)*y1(lINO3)
      r229 = rk(229)*y1(lINO3)*H2O
c
